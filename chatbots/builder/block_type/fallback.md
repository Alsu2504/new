...
{% hint style="info" %}
Подробнее об отправке эксклюзивных предложений с помощью рассылок или проверке валидности номера телефона [рассказали ниже. ](fallback.md#primer-proverki-dannykh)
{% endhint %}
...
По своим функциям данный вид блока аналогичен блоку [Стартовое условие](trigger/) с той лишь разницей, что клиент в этот блок не попадает.
...
Не состояние — это серый блок. У него нет условия как в блоке [Состояние диалога](without_trigger.md#blok-sostoyanie-dialoga), но в него нельзя перейти.&#x20;
...
Полный список регулярных выражений можно найти в статье "[Список полезных регулярных выражений](../../peremennye-i-funkcii/kalkulyator/dlya-raboty-s-regulyarnymi-vyrazheniyami/spisok-poleznykh-regulyarnykh-vyrazhenii.md)".
{% endhint %}
