...
Поле, которое отвечает за выбор типа блока. Подробнее о типах блоков читайте [в данной **статье**](buttons/type.md)
...
&#x20;\
От блока "Введи номер телефона идут две стрелки: [стрелка со сбором данных](../connections/type.md#strelka-so-sborom-dannykh) к блоку "Твой номер... "  и стрелка [с пустым условием](../connections/type.md#strelka-s-usloviem) к блоку "Попробуй еще раз".\
\
В стрелке со сбором данных в поле Условие указываем [регулярное выражение](../../peremennye-i-funkcii/kalkulyator/dlya-raboty-s-regulyarnymi-vyrazheniyami/) - условие, с помощью которого бот может проверять формат введенных данных: пользователь ввел именно номер телефона или что-то иное. \
\
