...
### Добавить аккаунт в контакты

create\_telegram\_client\_by\_username(username, name, group) - добавляет аккаунт с указанным юзернеймом в контакты в Телеграм-аккаунте и создает соответствующего клиента в Salebot
