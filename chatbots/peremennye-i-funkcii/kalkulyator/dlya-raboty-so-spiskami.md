...
<figure><img src="../../../.gitbook/assets/image (753).png" alt=""><figcaption><p>Подсчет общего количества клиентов в списке</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (754).png" alt=""><figcaption><p>Получение общего количества уникальных записей в списках</p></figcaption></figure>
...
{% tab title="Пример" %}
<figure><img src="../../../.gitbook/assets/image (757).png" alt=""><figcaption><p>Проверка наличия в списке при вступлении в канал</p></figcaption></figure>

<figure><img src="../../../.gitbook/assets/image (758).png" alt=""><figcaption><p>Проверка наличия в списке по ID  в мессенджере</p></figcaption></figure>
{% endtab %}
...
## Получить массив ID всех списков клиента

get\_all\_client\_list\_ids(client\_id)

{% tabs %}
{% tab title="Описание" %}
get\_all\_client\_list\_ids(client\_id) — возвращает массив с ID всех списков, в которых состоит клиент.

Если клиент не состоит ни в одном списке — возвращает пустой массив \[].
