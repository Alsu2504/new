...
{% hint style="success" %}
Доступно только на тарифе "Бесплатный" (до 10 учеников) и "Инфобиз"
{% endhint %}
...
{% hint style="info" %}
Как создать запись А,[ читайте в этой статье.](../../websites/builder/nastroiki-saita.md#kak-ustanovit-svoi-domen)
{% endhint %}
...
{% hint style="info" %}
Подробнее о секциях сайта для онлайн-курса рассказали в статье "[Секции для онлайн-курса](../../websites/builder/sekcii-bloki/sekcii-dlya-onlain-kursa.md)"
{% endhint %}
