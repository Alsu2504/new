...
### Где скачать приложение для учеников?

Salebot Skillhub — это мобильное приложение и образовательная платформа от Salebot, созданная для удобного прохождения онлайн-курсов. Оно позволяет ученикам получать доступ к учебным материалам, выполнять задания и общаться с преподавателями прямо со смартфона. Приложение доступно для Android, iOS и RuStore.

{% embed url="https://play.google.com/store/apps/details?hl=ru&id=pro.salebot_education.mobile_client&utm_source=chatgpt.com" %}

{% embed url="https://apps.apple.com/ru/app/salebot-skillhub/id6745255276" %}

{% embed url="https://www.rustore.ru/catalog/app/pro.salebot_education.mobile_client" %}

#### Основные возможности

* Каталог курсов — быстрый доступ ко всем доступным программам обучения.
* Прохождение уроков — просмотр текстовых материалов, видеоуроков и другого образовательного контента.
* Домашние задания — выполнение и отправка работ на проверку непосредственно из приложения.
* Общение с куратором — встроенный чат позволяет задавать вопросы, получать обратную связь и сопровождение в процессе обучения.
* Push-уведомления — ученики получают уведомления о проверке домашних заданий, новых комментариях преподавателя и важных обновлениях курса.
* Обучение в любом месте — весь учебный процесс доступен с мобильного устройства без необходимости использовать компьютер.

#### Для кого подходит

[Salebot Skillhub](https://skillhub.salebot.pro) предназначен для:
...
Приложение помогает сделать обучение более удобным и повышает вовлеченность учеников благодаря мобильному формату, быстрому доступу к материалам и постоянной связи с преподавателями. Платформа также поддерживает автоматическую проверку заданий, выдачу сертификатов и интеграцию с образовательной экосистемой Salebot.
