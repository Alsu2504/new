...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/Снимок экрана 2025-04-08 в 15.07.23.png" alt=""><figcaption></figcaption></figure></div>
...
* Заявки — показатель отображается, если на сайте создана форма заявки; показывает количество заполненных и отправленных вам заявок через [форму заявки](sekcii-bloki/sekciya-forma/);
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/Снимок экрана 2025-04-08 в 15.37.12.png" alt=""><figcaption></figcaption></figure></div>

Вы увидите кнопку "Код для сайта", кликните на нее чтобы открыть модальное окошко с кодом:

<div data-with-frame="true"><figure><img src="../../.gitbook/assets/Снимок экрана 2025-04-08 в 15.37.17.png" alt=""><figcaption></figcaption></figure></div>
